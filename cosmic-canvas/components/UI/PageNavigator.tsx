...
export default function PageNavigator() {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 flex items-center gap-2 sm:gap-3 
            px-3 sm:px-4 py-1.5 sm:py-2 bg-black/60 backdrop-blur-md rounded-full border border-white/10 shadow-xl"
        >
            ...
            <button
                ...
                className="p-1.5 sm:p-1 rounded-full hover:bg-white/10 transition-colors"
