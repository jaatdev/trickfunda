...
import { getKDConceptBySlug, getKDConcepts } from '@/utils/studyMaterialParser';
import { ConceptInteractiveViewer } from '@/components/study-material/ConceptInteractiveViewer';
import { Metadata } from 'next';
import { EnglishViewerWrapper } from '@/components/study-material/themes/english/EnglishViewerWrapper';
import { GoldenDustBackground } from '@/components/study-material/themes/english/GoldenDustBackground';
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return {
    title: `${concept.title} | English 100 Concepts | Study Material`,
      ...
      <div className="min-h-screen relative overflow-hidden pb-4 px-4 md:pb-8 md:px-8 pt-8">
        ...
        <div className="max-w-4xl mx-auto space-y-6 relative z-10">
          ...
          <div className="flex items-center space-x-2 text-sm text-amber-500/60 font-serif mb-8 border-b border-amber-900/30 pb-4">
            <Link href="/study-material" className="hover:text-amber-400 transition-colors">Study Material</Link>
            <span>/</span>
            <Link href="/study-material/english-100-concepts" className="hover:text-amber-400 transition-colors">English 100 Concepts</Link>
            <span>/</span>
