...
import { NeuralBackground } from '@/components/ui/study-material/NeuralBackground';
import { GlitchText } from '@/components/ui/study-material/GlitchText';
import { ScannerCard } from '@/components/ui/study-material/ScannerCard';
...
export default function StudyMaterialLandingClient({ categories }: { categories: Category[] }) {
  return (
    <div className="min-h-screen bg-[#020617] text-gray-100 pt-24 pb-12 px-4 md:pt-32 md:pb-16 md:px-8 relative overflow-hidden selection:bg-emerald-500/30">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <header className="space-y-6 text-center">
          ...
          >
            <GlitchText text="Study Material" />
          </motion.h1>
