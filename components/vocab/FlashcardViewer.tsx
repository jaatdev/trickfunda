        ...
        <AnimatePresence custom={direction} mode="wait">
          ...
          >
            ...
            >
              ...
              <div className="mt-8 text-blue-400/50 text-sm font-medium uppercase tracking-widest animate-bounce flex items-center justify-center gap-2 relative z-10">
            ...
            <motion.div 
              className="absolute inset-0 w-full h-full rounded-[2.5rem] bg-gradient-to-br from-[#111827] to-[#1f2937] border border-purple-500/30 shadow-[0_0_50px_rgba(168,85,247,0.15)] flex flex-col items-center p-8 md:p-10 overflow-y-auto overflow-x-hidden scrollbar-hide"
              initial={false}
              animate={{ rotateX: flipState === 0 ? -180 : 0 }}
              transition={{ type: "spring", stiffness: 260, damping: 20 }}
            ...
            >
              ...
              <div className="mt-8 text-purple-400/50 text-sm font-medium uppercase tracking-widest animate-bounce flex items-center justify-center gap-2 relative z-10">
            ...
            <div className="absolute inset-0 w-full h-full rounded-[2.5rem] overflow-hidden z-20 pointer-events-none">
              ...
              >
                ...
                <div className="mt-8 text-emerald-400/70 text-sm font-medium uppercase tracking-widest animate-pulse flex items-center justify-center gap-2 relative z-10">
